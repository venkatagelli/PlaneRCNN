...
def evaluate(options):
    ...
    original = cv2.imread("demotest/phsample.png")
    ...
    folder = "test/infernece/0_model_0.ply"
    index = 0
...
if __name__ == '__main__':
    ...
    if args.debug:
        ...
        args.printInfo = True
        pass
    args.customDataFolder="demotest"
    ...
    # q = cv2.waitKey(1)
    # cv2.destroyAllWindows()
    # image = cv2.imread("demostore/phsample.png")
    # image = cv2.resize(image,(640,480))
    # rotated = imutils.rotate(image, -90)
    # cv2.imwrite("demostore/phsample.png",rotated)
